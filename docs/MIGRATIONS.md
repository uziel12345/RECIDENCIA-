...
| `migration-campus-discovery-20260805.sql` | Agrega cargos públicos, calles, consultas rápidas, alias y estado de validación de servicios. Reversión en `rollback-campus-discovery-20260805.sql`; datos en `seed-campus-discovery-20260805.sql`. | Aplicado y verificado contra BD local (`mapa_ito`) el 2026-08-06 — incorporado en el esquema actual | 2026-08-05 |
