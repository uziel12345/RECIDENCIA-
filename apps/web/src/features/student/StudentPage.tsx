      ...
      <div className="student-page">
        <aside className="student-page__sidebar">
          <div className="student-page__sidebar-header">
            <div className="student-page__user">
              ...
              <div className="student-page__user-info">
                <span className="student-page__user-name">{user?.name || "Estudiante"}</span>
                <span className="student-page__user-role">Alumno</span>
              </div>
            </div>
            <button className="student-page__logout" onClick={handleLogout} title="Cerrar sesion">
              <LogOutIcon size={18} />
            </button>
          </div>
          ...
          <nav className="student-page__nav">
            <button
              className={`student-page__nav-item ${viewMode === "map" ? "is-active" : ""}`}
            ...
            <button
              className={`student-page__nav-item ${viewMode === "schedule" ? "is-active" : ""}`}
          ...
          {viewMode === "schedule" && (
            <div className="student-page__sidebar-content">
              <SchedulePanel onNavigateToClass={(buildingId) => {
                setViewMode("map");
