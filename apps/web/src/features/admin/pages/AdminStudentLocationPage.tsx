    ...
    <AdminLayout>
      <div style={s.page}>
        ...
        <div style={s.notice}>
          ...
          <span>
            Requiere sesión activa con rol <strong style={{ color: "#93c5fd" }}>Servicios Escolares</strong> o superior. Acceso sin sesión devuelve 401.
          </span>
        </div>
...
const s: Record<string, CSSProperties> = {
  ...
  headerIcon: { width: 44, height: 44, borderRadius: 12, background: "rgba(59,130,246,0.1)", border: "1px solid rgba(59,130,246,0.2)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: 4 },
  overline: { margin: "0 0 5px", fontSize: 11, fontWeight: 700, color: "#3b82f6", textTransform: "uppercase", letterSpacing: "0.08em" },
  title: { margin: "0 0 5px", fontSize: 26, fontWeight: 700, color: "#f1f5f9", lineHeight: 1.1 },
  subtitle: { margin: 0, fontSize: 14, color: "#64748b" },
  notice: { display: "flex", alignItems: "flex-start", gap: 9, padding: "11px 14px", background: "rgba(59,130,246,0.07)", border: "1px solid rgba(59,130,246,0.15)", borderRadius: 10, fontSize: 13, color: "#94a3b8", lineHeight: 1.5, marginBottom: 22 },
  ...
  btnSearch: { display: "flex", alignItems: "center", justifyContent: "center", gap: 8, border: "none", borderRadius: 10, padding: "11px 20px", background: "#3b82f6", color: "#fff", fontWeight: 700, cursor: "pointer", fontSize: 14 },
  ...
  resultAvatar: { width: 40, height: 40, borderRadius: 10, background: "linear-gradient(135deg, #3b82f6, #1d4ed8)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16, fontWeight: 700, color: "#fff", flexShrink: 0 },
